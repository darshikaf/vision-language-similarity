...
class ImageProcessor:
    ...
    async def load_image(
        self, image_input: str | Image.Image | Path, image_loader: ImageLoader | None = None
    ) -> Image.Image:
        """
    ...
    async def load_images_batch(self, image_inputs: list[str | Image.Image | Path]) -> list[Image.Image | Exception]:
        """
