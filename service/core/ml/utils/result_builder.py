...
class ResultBuilder:
    ...
    def create_batch_results(
        ...
        """
        return [
            ResultBuilder.create_success_result(
                image_input, text_prompt, clip_score, avg_processing_time_ms
            )
            for image_input, text_prompt, clip_score in zip(image_inputs, text_prompts, clip_scores)
        ]
    ...
    def create_batch_error_results(
        ...
        return [
            ...
            for image_input, text_prompt in zip(image_inputs, text_prompts)
        ]
